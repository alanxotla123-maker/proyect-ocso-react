import { LuStore, LuUser, LuSettings, LuUsers, LuFrame, LuWallet, LuWheat, LuTruck } from "react-icons/lu";
import NavItem from "./NavItem";
export default function Sidebar() {

    return (
        <nav className="w-1/12 h-[90vh] bg-orange-200 flex flex-col items-center py-20 justify-center gap-y-10">
